...
#         writer.add_scalar('testtime_ncm_original', t2/22400*1000, run)
        ...
        writer.add_scalar('testtime_train', t1/93056*1000, run)
        writer.add_scalar('testtime_test', t2/22400*1000, run)
...
#         writer.add_scalars('precision', {'train_precision_ncm':train_precision,'test_precision_ncm':test_precision}, run)
        ...
        writer.add_scalars('accuracy', {'train_accuracy_conv':train_accuracy,'test_accuracy_conv':test_accuracy}, run)
        writer.add_scalars('recall', {'train_recall_conv':train_recall,'test_recall_conv':test_recall}, run)
        writer.add_scalars('precision', {'train_precision_conv':train_precision,'test_precision_conv':test_precision}, run)
